...
def pbc_feature(diff):
    """
    Efficiently compute the minimum image distance under periodic boundary conditions
    assuming 2D torsional angle differences in radians.
    """
    # Wrap each component to [-π, π]
